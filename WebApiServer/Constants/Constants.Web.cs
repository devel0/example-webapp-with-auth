...
public static partial class Constants
{
    ...
    public const string WEB_Bearer = "Bearer";

    public const string WEB_ApplicationCookieName = "ExampleWebApp";

    public const string WEB_Cookie = "Cookie";
    public const string WEB_CookieName_XAccessToken = "X-Access-Token";
    public const string WEB_CookieName_XUsername = "X-Username";
